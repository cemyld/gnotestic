...
class similar_sections:
    ...
    def generate_targets(self):
        ...
        for k in list(self.pair_dict.keys()):
            l.append(k[0])
            l.append(k[1])
        l = list(set(l))
        ...
        for mid1 in l:
            for mid2 in l:
                if mid1 == mid2: pass
                elif (mid1, mid2) in list(out_dict.keys()): pass
                elif (mid2, mid1) in list(out_dict.keys()): pass
                else:
        ...
        for mid1 in l:
            for mid2 in l:
                if mid1 == mid2: pass
                    ...
                    if counter > 4 * len(list(self.pair_dict.keys())) ** 1.5:
                        pass
                    else:
                        counter += 1
                        out_dict[(mid1, mid2)] = 0
